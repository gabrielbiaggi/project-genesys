...
def initialize_tools():
    ...
    from .file_metadata_tools import register_file_metadata_tools
    from .os_tools import register_os_tools
    from .project_context_tools import register_project_context_tools
