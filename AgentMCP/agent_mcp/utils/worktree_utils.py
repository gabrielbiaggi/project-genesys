...
def create_git_worktree(
    path: str, branch: str, base_branch: str = "main", repo_path: str = "."
) -> Dict[str, Any]:
    """
...
def cleanup_git_worktree(
    ...
    try:
        ...
        return {"success": False, "error": "Timeout removing worktree", "path": path}
    except Exception as e:
    ...
    try:
        ...
        for cmd in commands:
            ...
            try:
                ...
                cmd_result = {"command": cmd, "success": False, "error": str(e)}
                results.append(cmd_result)
