...
async def start_background_tasks(task_group: anyio.abc.TaskGroup):
    ...
    # Start Autonomous Researcher - MOVED TO ON-DEMAND API CALL
    # researcher_interval = int(os.environ.get("MCP_AUTONOMOUS_RESEARCH_INTERVAL_SECONDS", "3600"))
    # g.autonomous_research_task_scope = await task_group.start(
    #     run_autonomous_research_loop, researcher_interval
    # )
    # logger.info(f"Autonomous researcher task started with interval {researcher_interval}s.")
